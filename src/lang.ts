const lang = {
  ...
  'ChatList.Main.EmptyPlaceholder.Subtitle': 'You have %s on Loopinuz',
  'ChatList.Main.EmptyPlaceholder.SubtitleNoContacts': 'Use Loopinuz app on your [Android](https://telegram.org/android) or [iOS](https://telegram.org/dl/ios) device to sync your contacts',
  ...
  'ClientPip.PlaceholderTitle': 'Loopinuz is in Picture-in-Picture',
  ...
  'Deactivated.Subtitle': 'Loopinuz supports only one active tab with the app.\nClick anywhere to continue using this tab.',
  'Deactivated.Version.Title': 'WebK has updated...',
  'Deactivated.Version.Subtitle': 'Another tab is running a newer version of Loopinuz.\nClick anywhere to reload this tab.',
  ...
  'Notifications.Default': 'Give Loopinuz permission to send notifications. You may need to refresh the page to see the changes.',
  ...
  'Message.Unsupported.Desktop': '__This message is currently not supported on Loopinuz Web. Try [getdesktop.telegram.org](https://getdesktop.telegram.org/)__',
  'Message.Unsupported.Mobile': '__This message is currently not supported on Loopinuz Web. Try [telegram.org/dl](https://telegram.org/dl/)__',
  ...
  'PushNotification.Message.Refreshing': 'Loopinuz is syncing in the background...',
  'LogOut.Description': 'Are you sure you want to log out?\n\nNote that you can seamlessly use Loopinuz on all your devices at once.',
  // "PushNotification.Action.Mute1d.Success": "Notification settings were successfully saved.",
  // it is from iOS
  ...
  'Video.Unsupported.Desktop': '__Unfortunately, this video can\'t be played on Loopinuz Web. Try opening it with our [desktop app](https://getdesktop.telegram.org/) instead.__',
  'Video.Unsupported.Mobile': '__Unfortunately, this video can\'t be played on Loopinuz Web. Try opening it with our [mobile app](https://telegram.org/dl/) instead.__',
  ...
  'BoostsViaGifts.EndSubtitle': {
    'one_value': 'Choose when %d subscriber of your channel will receive Loopinuz Premium.',
    'other_value': 'Choose when %d subscribers of your channel will be randomly selected to receive Loopinuz Premium.'
  },
  ...
  'BoostsViaGifts.DurationSubtitle': 'You can review the list of features and terms of use for Loopinuz Premium [here]().',
  ...
  'Giveaway.Info': 'On **%s**, Loopinuz will automatically select %s **%s**.',
  'Giveaway.Info.End': 'On **%s**, Loopinuz automatically selected %s **%s**.',
  'Giveaway.Info.Date': 'On **%s**, Loopinuz will automatically select %s **%s** after **%s**.',
  'Giveaway.Info.Date.End': 'On **%s**, Loopinuz automatically selected %s **%s** after **%s**.',
  'Giveaway.Info.Several': 'On **%s**, Loopinuz will automatically select %s **%s** and %s.',
  'Giveaway.Info.Several.End': 'On **%s**, Loopinuz automatically selected %s **%s** and %s.',
  'Giveaway.Info.Several.Date': 'On **%s**, Loopinuz will automatically select %s **%s** and %s after **%s**.',
  'Giveaway.Info.Several.Date.End': 'On **%s**, Loopinuz automatically selected %s **%s** and %s after **%s**.',
  ...
  'Multiplier': '%s x %s',
  'Giveaway.Results': {
    'one_value': '%d winner of the giveaway was randomly selected by Loopinuz and received private message with giftcode.',
    'other_value': '%d winners of the giveaway were randomly selected by Loopinuz and received private messages with giftcodes.'
  },
  ...
  'Giveaway.Results.NoWinners': {
    'one_value': 'Due to the giveaway terms, no winner could be selected by Loopinuz, **1** gift link was forwarded to channel administrators.',
    'other_value': 'Due to the giveaway terms, no winners could be selected by Loopinuz, all **%d** gift links were forwarded to channel administrators.'
  },
  'Giveaway.Results.NoWinners.Stars': 'Due to the giveaway terms, no winners could be selected by Loopinuz, all stars were credited to channel administrators.',
  ...
  'BoostsViaGifts.AdditionalPrizesSubtitleOff': 'Turn this on if you want to give the winners your own prizes in addition to Loopinuz Premium subscriptions.',
  'BoostsViaGifts.AdditionalPrizesDetailed': {
    'one_value': '**%d** Loopinuz Premium subscription for %s',
    'other_value': '**%d** Loopinuz Premium subscriptions for %s'
  },
  'BoostsViaGifts.AdditionalPrizesDetailedWith': {
    'one_value': '**%d** %s with Loopinuz Premium subscription for %s',
    'other_value': '**%d** %s with Loopinuz Premium subscriptions for %s'
  },
  ...
  'Giveaway.With': 'with',
  'Giveaway.WithSubscriptionsSingle': 'Loopinuz Premium subscription for %s',
  'Giveaway.WithSubscriptionsPlural': 'Loopinuz Premium subscriptions for %s',
  'Giveaway.WithStars': {
  ...
  'Giveaway.Results.Subtitle': {
    'one_value': '%1$d winner of the **[Giveaway]()** was randomly selected by Loopinuz.',
    'other_value': '%1$d winners of the **[Giveaway]()** were randomly selected by Loopinuz.'
  },
  ...
  'GiftCode.ShareReceived': 'This link allows you or **[anyone you choose]()** to activate a **Loopinuz Premium** subscription.',
  'GiftModal.Title.You': 'You gifted **%1$s** a %2$s subscription to Loopinuz Premium.',
  ...
  'SimilarChannels.Unlock': {
    'one_value': 'Subscribe to **[Loopinuz Premium]()** to unlock up to **%d** similar channel.',
    'other_value': 'Subscribe to **[Loopinuz Premium]()** to unlock up to **%d** similar channels.'
  },
  ...
  'Boost.GetMoreBoosts': {
    'one_value': 'To boost **%1$s**, get **%2$d** more boost by gifting **Loopinuz Premium** to a friend.',
    'other_value': 'To boost **%1$s**, get **%2$d** more boosts by gifting **Loopinuz Premium** to a friend.'
  },
  'Boost.Reassign.Description': 'To boost **%1$s**, reassign a previous boost or %2$s to a friend to get %3$s.',
  'Boost.GiftPremium': '**[gift Loopinuz Premium]()**',
  'Boost.Additional': {
  ...
  'Boost.Reassign.Wait': 'Wait until the boost is available or get %s by gifting a **[Loopinuz Premium]()** subscription.',
  ...
  'Privacy.VoiceMessagesPremiumCaption': 'Subscribe to Loopinuz Premium to restrict who can send you voice or video messages.\n\n**[What is Loopinuz Premium?]()**',
  ...
  'Privacy.GiftsPremiumError': 'Subscribe to [Loopinuz Premium]() to restrict who can send you gifts.',
  ...
  'PrivacySettings.Messages.PremiumError': 'Only subscribers of [Loopinuz Premium]() can restrict receiving messages.',
  ...
  'OnlyPremiumCanMessage': '**%s** only accepts messages from contacts and **[Loopinuz Premium]()** subscribers.',
  ...
  'Rtmp.MediaViewer.Failed.Description': 'Loopinuz doesn\'t see any stream coming from your streaming app. Please make sure you entered the right Server URL and Stream Key in your app.',
  ...
  'MultiAccount.AccountsLimitDescription': 'You have reached the limit of **3** connected accounts. You can add more by subscribing to **Loopinuz Premium**.',
  ...
  'InviteViaLink.Premium.Subscribe': 'Subscribe to Loopinuz Premium',
  ...
  'Frozen.Violation.Subtitle': 'Your account was frozen for breaking Loopinuz’s Terms of Service.',
  ...
  'Verified.Bot': 'This bot is verified as official by the representatives of Loopinuz.',
  'Verified.Channel': 'This channel was verified by Loopinuz.',
  'Verified.Group': 'This group was verified by Loopinuz.',
  'ProfileUnofficialSecurityRisk': '%1$s uses an unofficial Loopinuz client — messages to this user may be less secure.',
  // 'SavedMessages.Count': {
  ...
  'Summary.Limited.Text': 'Subscribe to [Loopinuz Premium]() to increase summary limits.',
  ...
  'LoopinuzPremiumSubscribedTitle': 'You are all set!',
  'LoopinuzPremiumSubscribedSubtitle': 'Thank you for subscribing to **Loopinuz Premium**.\nHere’s what is now unlocked.',
  'LoopinuzPremiumPeerTitle': '%s is a subscriber of **Loopinuz Premium**',
  'LoopinuzPremiumPeerSubtitle': 'Owners of **Loopinuz Premium** accounts have exclusive access to multiple additional features.',
  'LoopinuzPremiumPeerTitleEmojiStatus': '%s set this emoji from [%s]() as their current status.',
  'LoopinuzPremiumPeerTitleEmojiStatusNoPack': '%s set this emoji as their current status.',
  'LoopinuzPremiumPeerSubtitleEmojiStatus': 'Emoji statuses are a premium feature. Other features included in **Loopinuz Premium**:',
  ...
  'ContactJoined': 'Contact joined Loopinuz',
  'Loading': 'Loading...',
  'Unblock': 'Unblock',
  ...
  'PrivacyPhoneInfo': 'Users who have your number saved in their contacts will also see it on Loopinuz.',
  'PrivacyPhoneInfo3': 'Users who add your number to their contacts will see it on Loopinuz only if they are your contacts.',
  ...
  'UsernameHelp': 'You can choose a username on **Loopinuz**. If you do, people will be able to find you by this username and contact you without needing your phone number.\n\nYou can use **a–z**, **0–9** and underscores. Minimum length is **5** characters.',
  'Phone': 'Phone',
  ...
  'YourEmailSkipWarningText': 'No, seriously.\n\nIf you forget your password, you will lose access to your Loopinuz account. There will be no way to restore it.',
  ...
  'LoopinuzFeatures': 'Loopinuz Features',
  ...
  'NoUsernameFound': 'There is no Loopinuz account with this username.',
  ...
  'ReportSentInfo': 'Loopinuz moderators will review your report.\nThank you for your cooperation!',
  ...
  'SessionsListInfo': 'The official Loopinuz app is available for Android, iPhone, iPad, Windows, macOS and Linux.',
  'SponsoredMessage': 'ad',
  ...
  'LoopinuzFeaturesUrl': 'https://t.me/LoopinuzTips',
  'ScamMessage': 'SCAM',
  'FakeMessage': 'FAKE',
  ...
  'PaymentCardSavePaymentInformationInfoLine1': 'You can save your payment info for future use. It will be stored directly with the payment provider. Loopinuz has no access to your credit card data.',
  'Done': 'Done',
  ...
  'PrivacyPaymentsClearInfo': 'You can delete your shipping info and instruct all payment providers to remove your saved credit cards. Note that Loopinuz never stores your credit card data.',
  ...
  'LimitReachedPinDialogs': 'You can\'t pin more than %1$d chats to the top. Unpin some that are currently pinned – or subscribe to **Loopinuz Premium** to double the limit to **%2$d** chats.',
  ...
  'LimitReachedCommunities': 'You are a member of **%1$d** groups and channels. Please leave some before joining a new one — or subscribe to **Loopinuz Premium** to double the limit to **%2$d** groups and channels.',
  ...
  'WebSessionsTitle': 'Logged In with Loopinuz',
  'TerminateWebSessionText': 'Are you sure you want to disconnect %1$s?',
  'Disconnect': 'Disconnect',
  'TerminateAllWebSessions': 'Disconnect All Websites',
  'AreYouSureWebSessions': 'Are you sure you want to disconnect all websites where you logged in with Loopinuz?',
  'ClearOtherWebSessionsHelp': 'You can log in on websites that support signing in with Loopinuz.',
  'TerminateWebSessionInfo': 'Click to disconnect from your Loopinuz account.',
  'EnablePhotoSpoiler': 'Hide with spoiler',
  'DisablePhotoSpoiler': 'Remove spoiler',
  'LimitReachedFolders': 'You have reached the limit of **%1$d** folders. You can double the limit to **%2$d** folders by subscribing to **Loopinuz Premium**.',
  ...
  'LimitReachedSharedFolderInvites': 'You have reached the limit of **%1$d** links. You can double the limit to **%2$d** links by subscribing to **Loopinuz Premium**.',
  ...
  'GiftLoopinuzPremiumTitle': 'Gift Loopinuz Premium',
  'GiftLoopinuzPremiumDescription': 'Give **%1$s** access to exclusive features with **Loopinuz Premium**.',
  ...
  'ActionGiftPremiumSubtitle2': 'Subscription for exclusive Loopinuz features.',
  'ChatAdmin': 'admin',
  ...
  'ChannelAntiSpamInfo': 'Loopinuz will filter more spam, but may occasionally affect ordinary messages. You can report False Positives in Recent Actions.',
  'ChannelLinkInfo': 'Anyone who has Loopinuz installed will be able to join your channel by following this link.',
  ...
  'BotWebAppDisclaimerSubtitle': 'You are about to use a mini app operated by an independent party **not affiliated with Loopinuz**. You must agree to the Terms of Use for mini apps to continue.',
  ...
  'PremiumNeededForBoosting': 'Only **Loopinuz Premium** subscribers can boost channels. Do you want to subscribe to **Loopinuz Premium**?',
  ...
  'CantBoostWithGiftedPremiumDescription': 'Because your **Loopinuz Premium** subscription was gifted to you, you can\'t use it to boost channels.',
  'MoreBoosts': {
  ...
  'BoostingGiveawayJustStarted': '%s just started a giveaway of Loopinuz Premium subscriptions to its followers.',
  'BoostingWinnersDate': '**Winners Selection Date**',
  'BoostingGiveawayPrizes': '**Giveaway Prizes**',
  'BoostingGiveawayMsgInfoPlural1': {
    'other_value': '**%1$d** Loopinuz Premium'
  },
  ...
  'BoostingGiveawayHowItWorksText': {
    'one_value': 'This giveaway is sponsored by the admins of **%2$s**, who acquired **%3$s Loopinuz Premium** subscription for %4$s for its followers.',
    'other_value': 'This giveaway is sponsored by the admins of **%2$s**, who acquired **%3$s Loopinuz Premium** subscriptions for %4$s for its followers.'
  },
  ...
  'BoostingGiveawayHowItWorksTextEnd': {
    'one_value': 'This giveaway was sponsored by the admins of **%2$s**, who acquired **%3$s Loopinuz Premium** subscription for %4$s for its followers.',
    'other_value': 'This giveaway was sponsored by the admins of **%2$s**, who acquired **%3$s Loopinuz Premium** subscriptions for %4$s for its followers.'
  },
  ...
  'BoostingReceivedPrizeDuration': 'Your prize is a **Loopinuz Premium** subscription for %s.',
  'BoostingUnclaimedPrize': 'Unclaimed Prize',
  'BoostingYouHaveUnclaimedPrize': 'You have an unclaimed prize from a giveaway by **%s**.',
  'BoostingUnclaimedPrizeDuration': 'This prize is a **Loopinuz Premium** subscription for %s.',
  ...
  'BoostingReceivedGiftDuration': 'Your gift is a **Loopinuz Premium**\nsubscription for %s.',
  'BoostingUsedGiftLink': 'Used Gift Link',
  'BoostingGiftLink': 'Gift Link',
  'BoostingLinkUsed': 'This link was used to activate\na **Loopinuz Premium** subscription.',
  'BoostingLinkAllows': 'This link allows you to activate\na **Loopinuz Premium** subscription.',
  'BoostingLinkAllowsToUser': 'This link allows **%1$s** to activate a **Loopinuz Premium** subscription.',
  ...
  'BoostingDate': 'Date',
  'BoostingLoopinuzPremiumFor': 'Loopinuz Premium for %s',
  ...
  'BoostingPremium': 'Loopinuz Premium',
  'BoostingStars': 'Loopinuz Stars',
  ...
  'LimitReachedChatInFolders': 'Sorry, you can\'t add more than **%1$d** chats to a folder. You can increase this limit to **%2$d** by subscribing to **Loopinuz Premium**.',
  ...
  'LoopinuzPremiumUserGiftedPremiumDialogTitleWithPlural': '**%1$s** has gifted you a %2$s subscription to Loopinuz Premium.',
  'LoopinuzPremiumUserGiftedPremiumDialogTitleWithPluralSomeone': 'Someone has gifted you a %1$s subscription to Loopinuz Premium.',
  'LoopinuzPremiumUserGiftedPremiumDialogSubtitle': 'You now have access to additional features.',
  'LoopinuzPremiumUserGiftedPremiumOutboundDialogSubtitle': '**%1$s** now has access to additional features.',
  'GiftMonths': {
    'one_value': '%1$d-month',
    'other_value': '%1$d-months'
  },
  ...
  'GiftPremiumActivateErrorTitle': 'You already have Loopinuz Premium',
  ...
  'PrivacyLastSeenPremium': 'Subscribe to Loopinuz Premium',
  ...
  'PrivacyLastSeenPremiumForPremium': 'Subscribed to Loopinuz Premium',
  'PrivacyLastSeenPremiumInfoForPremium': 'Because you are a Loopinuz Premium subscriber, you will see the last seen and read time of all users who are sharing it with you – even if you are hiding yours.',
  ...
  'PremiumReadButton2': 'Subscribe to Loopinuz Premium',
  ...
  'PremiumLastSeenButton2': 'Subscribe to Loopinuz Premium',
  ...
  'AdHidden': 'You will no longer see ads from Loopinuz.',
  'SponsoredMessageAdWhatIsThis': 'what\'s this?',
  'RevenueSharingAdsAlertSubtitle': 'Loopinuz Ads are very different from ads on other platforms. Ads such as this one:',
  'RevenueSharingAdsInfo1Title': 'Respect Your Privacy',
  'RevenueSharingAdsInfo1Subtitle': 'Ads on Loopinuz do not use your personal information and are based on the channel in which you see them.',
  'RevenueSharingAdsInfo2Title': 'Help the Channel Creator',
  'RevenueSharingAdsInfo2Subtitle': '50% of the revenue from Loopinuz Ads goes to the owner of the channel where they are displayed.',
  'RevenueSharingAdsInfo3Title': 'Can Be Removed',
  'RevenueSharingAdsInfo3Subtitle': 'You can turn off ads by subscribing to **Loopinuz Premium**, and Level %1$s channels can remove them for their subscribers.',
  'RevenueSharingAdsInfo4Title': 'Can I Launch an Ad?',
  'RevenueSharingAdsInfo4Subtitle2': 'Anyone can create an ad to display in this channel — with minimal budgets. Check out the **Loopinuz Ad Platform** for details. %1$s',
  ...
  'LoopinuzStars': 'Loopinuz Stars',
  'LoopinuzStarsInfo': 'Buy Stars to unlock content and services\nin mini apps on Loopinuz.',
  ...
  'MenuLoopinuzStars': 'My Stars',
  'MenuLoopinuzStarsTon': 'My Grams',
  'StarsCount': {
    'one_value': '%d Star',
    'other_value': '%d Stars'
  },
  ...
  'FactCheckToast': 'This clarification was provided by Loopinuz.',
  'FactCheckFooter': 'This clarification was provided by Loopinuz.',
  ...
  'AnimatedEffectPremium': 'Subscribe to **Loopinuz Premium** to add this animated effect.',
  ...
  'ActionGiftStarsSubtitle': 'With Stars, **%s** is able to unlock content and services on Loopinuz.',
  'ActionGiftStarsSubtitleYou': 'Use Stars to unlock content and services on Loopinuz.',
  'GiftStarsTitle': 'Gift Stars',
  'GiftStarsSubtitle': 'With Stars, **%s** will be able to unlock content and services on Loopinuz.',
  ...
  'StarGiftUpgradeTransferableText': 'Send your upgraded gift to any of your friends on Loopinuz.',
  'StarGiftUpgradeTransferableTextPrepaid': '%s will be able to send the gift to anyone on Loopinuz.',
  ...
  'StarGiftValueAboutAverage': 'The average sale price of **%s** gifts on Loopinuz and Fragment over the past month.',
  'StarGiftValueAboutLastFragment': 'This is the price at which **%s** was last sold on Fragment',
  'StarGiftValueAboutLastLoopinuz': 'This is the price at which **%s** was last sold on Loopinuz',
  ...
  'StarGiftMinimumPriceTooltip': '**%s** is the floor price for **%s** gifts listed on Loopinuz and Fragment.',
  'StarGiftAveragePrice': 'Average Price',
  'StarGiftAveragePriceTooltip': '**%s** is the average sale price of **%s** gifts on Loopinuz and Fragment over the past month.',
  'StarGiftViewResaleLoopinuz': '%s for sale on Loopinuz %s',
  ...
  'LoopinuzStarsGift': 'Gift Stars to Friends',
  'StarsSentText': {
  ...
  'Reported2': 'Loopinuz moderators will review your report. Thank you!',
  ...
  'Contacts.PhoneNumber.NotRegistred': 'The person with this phone number is not registered on Loopinuz yet.',
  'Channel.UsernameAboutChannel': 'People can share this link with others and can find your channel using Loopinuz search.',
  'Channel.UsernameAboutGroup': 'People can share this link with others and find your group using Loopinuz search.',
  ...
  'Chat.Service.PeerJoinedLoopinuz': '%@ joined Loopinuz',
  ...
  'Chat.Message.Ad.Text': 'Unlike other apps, Loopinuz never uses your private data to target ads. Sponsored messages on Loopinuz are based solely on the topic of the public channels in which they are shown. This means that no user data is mined or analyzed to display ads, and every user viewing a channel on Loopinuz sees the same sponsored messages.\n\nUnlike other apps, Loopinuz doesn\'t track whether you tapped on a sponsored message and doesn\'t profile you based on your activity. We also prevent external links in sponsored messages to ensure that third parties can’t spy on our users. We believe that everyone has the right to privacy, and technological platforms should respect that.\n\nLoopinuz offers a free and unlimited service to hundreds of millions of users, which involves significant server and traffic costs. In order to remain independent and stay true to its values, Loopinuz developed a paid tool to promote messages with user privacy in mind. We welcome responsible advertisers at:\n\n%@\n\nSponsored Messages are currently in test mode. Once they are fully launched and allow Loopinuz to cover its basic costs, we will start sharing ad revenue with the owners of public channels in which sponsored messages are displayed.\n\nOnline ads should no longer be synonymous with abuse of user privacy. Let us redefine how a tech company should operate – together.',
  ...
  'CustomEmoji.PremiumAlert': 'Subscribe to Loopinuz Premium to unlock this emoji. [Read More]()',
  'Date.Today': 'Today',
  ...
  // 'LiteMode.Key.animations.Info': 'Other animations that make Loopinuz look amazing.',
  ...
  'PrivacySettings.Voice.PremiumError': 'Only subscribers of [Loopinuz Premium]() can restrict receiving Voice and Video Messages.',
  ...
  'PrivacySettingsController.P2p.Desc': 'Disabling peer-to-peer will relay all calls through Loopinuz servers to avoid revealing your IP address, but may slightly decrease audio and video quality.',
  ...
  'Action.SuggestedProfilePhoto': 'un1 suggests this photo for your Loopinuz profile',
  ...
  'Loopinuz.GeneralSettingsViewController': 'General Settings',
  'Loopinuz.InstalledStickerPacksController': 'Stickers',
  'Loopinuz.NotificationSettingsViewController': 'Notifications',
  'Loopinuz.LanguageViewController': 'Language',
  ...
  'Schedule.Repeat.PremiumRequired': 'Subscribe to **[Loopinuz Premium]()** to schedule repeating messages.',
  ...
  'TwoStepAuth.GenericHelp': 'You have enabled Two-Step verification.\nYou\'ll need the password you set up here to log in to your Loopinuz account.',
  ...
  'Premium.Boarding.NoAds.Info': 'No more ads in public channels where Loopinuz sometimes shows ads.',
  ...
  'Premium.Boarding.Badge.Info': 'An exclusive badge next to your name showing that you subscribe to Loopinuz Premium.',
  ...
  'Premium.Boarding.Title': 'Loopinuz Premium',
  'Premium.Boarding.Info': 'Go **beyond the limits** and **unlock dozens of exclusive** features by subscribing to **Loopinuz Premium**.',
  'Premium.Boarding.Got.Title': 'You are all set!',
  'Premium.Boarding.Got.Info': 'Thank you for subscribing to Loopinuz Premium. Here\'s what is now unlocked.',
  'Premium.Boarding.Peer.Title': '[%@](profile) is a subscriber of\nLoopinuz Premium',
  'Premium.Boarding.Peer.Info': 'Owners of Loopinuz Premium accounts have exclusive access to multiple additional features.',
  ...
  'Premium.Boarding.About.Title': 'About Loopinuz Premium',
  'Premium.Boarding.About.Text': 'While the free version of Loopinuz already gives its users more than any other messaging application, **Loopinuz Premium** pushes its capabilities even further.\n\n**Loopinuz Premium** is a paid option, because most Premium Features require additional expenses from Loopinuz to third parties such as data center providers and server manufacturers. Contributions from **Loopinuz Premium** users allow us to cover such costs and also help Loopinuz stay free for everyone.',
  'Premium.Boarding.About.Tos': 'By purchasing a Premium subscription, you agree to the Loopinuz [Terms of Service](terms) and [Privacy Policy](privacy).',
  'Premium.Boarding.AppStore.Cancelled': 'Purchase was canceled or failed.',
  'Premium.Boarding.AppStore.Success': 'You successfully subscribed for Loopinuz Premium.',
  ...
  'Premium.Offset.AlreadyHave': 'You already have Loopinuz Premium.',
  ...
  'Language.TranslateMessages.Channel.Premium': 'Subscribe to [Loopinuz Premium](premium) to translate entire chats.',
  ...
  'Chat.DownloadLimit.Text': {
    'one_value': 'Subscribe to [Loopinuz Premium]() to increase download speeds %d time.',
    'other_value': 'Subscribe to [Loopinuz Premium]() to increase download speeds %d times.'
  },
  'Chat.UploadLimit.Text': {
    'one_value': 'Subscribe to [Loopinuz Premium]() to increase upload speeds %d time.',
    'other_value': 'Subscribe to [Loopinuz Premium]() to increase upload speeds %d times.'
  },
  'Chat.Service.Refund': '%@ refunded %@',
  'EnableDarkMode': 'Enable Dark Mode',
  'DisableDarkMode': 'Disable Dark Mode',
  'DisableAnimations': 'Disable Animations',
  'AudioAndVideoTranscription.PremiumAlert': 'Subscribe to Loopinuz Premium to unlock video and audio transcription. [Read More]()',
  ...
  'PasscodeLock.Description': 'When a passcode is set, a lock icon appears above your chat list. Tap it to lock your Loopinuz.',
  ...
  'PasscodeLock.TapToLock': 'Tap to lock Loopinuz.',
  ...
  'PeerInfo.AppFooterAdmin': 'By publishing this mini app, you agree to the [Loopinuz Terms of Service for Developers](https://telegram.org/privacy).',
  ...
  'BotStorySharingNotSupported': 'Sharing to Stories is not supported in the Web app. Please use one of Loopinuz\'s mobile apps.',
  ...
  'VerificationCodesBotDescription': 'Third-party services, like websites and stores, can send verification codes to your phone number via Loopinuz instead of SMS. Such codes will appear in this chat.\n\nIf you didn\'t request any codes – don\'t worry! Most likely, someone made a mistake when entering their number.',
  ...
  'StarsRating.Subtitle': 'This rating reflects **%s**’s activity on Loopinuz. What affects it:',
  'StarsRating.SubtitleMy': 'This rating reflects your activity on Loopinuz. What affects it:',
  'StarsRating.Row1Title': 'Gifts from Loopinuz',
  'StarsRating.Row1Subtitle': '100% of the Stars spent on gifts purchased from Loopinuz.',
  ...
  'EmailSetup.ChangeSubtitle': 'You will receive Loopinuz login codes via email and not SMS. Please enter an email address to which you have access.',
  ...
  'AiEditor.PremiumFlood': 'You have hit the limit for now. Subscribe to [Loopinuz Premium]() to increase the limit by 50 times or try again later.',
