...
const handlebarsPlugin = handlebars({
  context: {
    title: 'Loopinuz Web',
    description: 'Loopinuz is a cloud-based mobile and desktop messaging app with a focus on security and speed.',
    url: 'https://web.loopinuz.org/k/',
    origin: 'https://web.loopinuz.org/'
  }
});
...
// * mkcert web.loopinuz.org
// * chmod 644 web.loopinuz.org-key.pem
// * nano /etc/hosts
// * 127.0.0.1 web.loopinuz.org
const host = USE_SSL ? 'web.loopinuz.org' : 'localhost';
